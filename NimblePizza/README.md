...
To update the database use this command from the Web project folder (replace `NimblePizza` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../NimblePizza.Infrastructure/NimblePizza.Infrastructure.csproj -s NimblePizza.Web.csproj
```
